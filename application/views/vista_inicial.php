...
<body>	
	<br/>	
	<!---ATENCION: solo funciona en pantalla de 1140 px--->
	<img id="Image-Maps-Com-image-maps-2016-02-10-075015" src="<?php echo base_url();?>images/fondopruebaSITE.png" border="0" width="1140" height="493" 
	orgWidth="1140" orgHeight="493" usemap="#image-maps-2016-02-10-075015" 
	class="img-responsive" alt="imagen splash" title="App Hackathon OpendataGov 2016 Corrientes"/>
	<!---------------------------------------------------->	
